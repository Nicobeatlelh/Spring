...
<link href="css/stylefac.css" type="text/css" rel="stylesheet">
<link href="css/printfac.css" type="text/css" rel="stylesheet">
...
c/o Steve Widget</textarea>
		...
		<table id="items">
		  ...
		  <tr class="item-row">
		  <td><textarea class="cost">1</textarea></td>
		  <td><textarea class="cost">1</textarea></td>
		  ...
		  <tr class="item-row">
		   <td><textarea class="cost">2</textarea></td>
		  <td><textarea class="cost">2</textarea></td>
